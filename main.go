...
import (
	...
	"github.com/Vioneta/VionetaOS-MessageBus/config"
	"github.com/Vioneta/VionetaOS-MessageBus/repository"
	"github.com/Vioneta/VionetaOS-MessageBus/route"
...
var (
	...
	//go:embed build/sysroot/etc/vionetaos/message-bus.conf.sample
	_confSample string
